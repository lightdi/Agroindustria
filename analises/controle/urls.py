...
urlpatterns =[
    ...
    path('criar_amostra/<int:analise_id>/', criar_amostra, name="criar_amostra"),
    path('editar_amostra/<int:id>/', editar_amostra, name="criar_amostra"),
    path('excluir_amostra/<int:id>/', excluir_amostra, name="excluir_amostra"),
